...
df_wnd_top_ticket = df_wnd_ticket.loc[(df_wnd_ticket['признак_выходного']>150)]
...
df_act_top_date.plot(ax=axes[0,0],figsize=(14,10), grid='on', title='Топ часов в рабочие дни',                     color='orange', label='line 1', linewidth=3, linestyle =':')
df_wnd_top_date.plot(ax=axes[0,1],figsize=(14,10), grid='on', title='Топ часов в выходные',                     color='orange', label='line 1', linewidth=3, linestyle ='--')

df_act_top_ticket.plot(ax=axes[1,0],figsize=(14,10), grid='on', title='Наиболее популярные способы оплаты в рабочие',                       color='green', label='line 1', linewidth=3, linestyle =':')
df_wnd_top_ticket.plot(ax=axes[1,1],figsize=(14,10), grid='on', title='Наиболее популярные способы оплаты в выходные',                       color='green', label='line 1', linewidth=3, linestyle ='--')
